...
import com.sv.youapp.service.authorization.converter.BytesToUsernamePasswordAuthenticationTokenConverter
import com.sv.youapp.service.authorization.converter.UserDTOMixin
import com.sv.youapp.service.authorization.converter.UsernamePasswordAuthenticationTokenToBytesConverter
import com.sv.youapp.service.authorization.repositories.jpa.ClientRepository
import com.sv.youapp.service.authorization.repositories.jpa.UserRepository
import com.sv.youapp.service.authorization.repositories.redis.OAuth2AuthorizationGrantAuthorizationRepository
import com.sv.youapp.service.authorization.services.impl.DefaultNativeUserDetails
import com.sv.youapp.service.authorization.services.impl.JpaRegisteredClientRepository
import com.sv.youapp.service.authorization.services.impl.RedisOAuth2AuthorizationService
...
@Configuration
@Profile("jdbc")
@EnableRedisRepositories("com.sv.youapp.service.authorization.repositories.redis")
@EnableJpaRepositories("com.sv.youapp.service.authorization.repositories.jpa")
