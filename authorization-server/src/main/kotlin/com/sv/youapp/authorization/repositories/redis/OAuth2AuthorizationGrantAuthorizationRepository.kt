...
interface OAuth2AuthorizationGrantAuthorizationRepository: CrudRepository<AbstractGrantAuthorization, String> {
    ...
    fun <T : OAuth2AuthorizationCodeGrantAuthorization?> findByStateOrAuthorizationCode_TokenValue(state: String?, authorizationCode: String?): T?
    ...
    fun <T : AbstractGrantAuthorization?> findByAccessToken_TokenValueOrRefreshToken_TokenValue(accessToken: String?, refreshToken: String?): T?
    ...
    fun <T : OAuth2DeviceCodeGrantAuthorization?> findByDeviceStateOrDeviceCode_TokenValueOrUserCode_TokenValue(deviceState: String?, deviceCode: String?, userCode: String?): T?
